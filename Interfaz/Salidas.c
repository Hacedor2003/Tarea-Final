...
/* Funcion para recibir los datos de los libros por el usuario*/
...
/* Funcion para mostrar por consola un entero*/
...
/*Funcion para mostrar por consola que un dato no existe*/
